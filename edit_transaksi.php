...
if (isset($_POST['update'])) {
	...
	$result = mysqli_query(
		$conn,
		"UPDATE transaksi SET id_transaksi='$id_transaksi',id_pembeli='$id_pembeli',id_produk='$id_produk',tgl_bayar='$tgl_bayar',total_harga='$total_bayar' WHERE id_pembeli=$id"
	);
...
<body>
	...
	<form name="update_user" method="post" action="edit_transaksi.php">
		<table border="0">
			<tr>
				<td>ID Transaksi</td>
				<td><input class="input" type="text" name="id_transaksi" value=<?php echo $id_transaksi; ?>></td>
			</tr>
			<tr>
				<td>ID Pembeli</td>
			...
			<tr>
				<td>Tanggal Bayar</td>
				<td><input type="text" class="input" id="date" name="tgl_bayar" value=<?php echo $tgl_bayar; ?>></td>
			</tr>
			<tr>
				<td>Total Harga</td>
				<td><input class="input" type="text" name="total_harga" value=<?php echo $total_harga; ?>></td>
			</tr>
			<tr>
