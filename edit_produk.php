...
{	
	...
	// update user data
	$result = mysqli_query($conn, "UPDATE produk SET id_produk='$id_produk',nama_produk='$nama_produk',kategori='$kategori',harga='$harga',stok='$stok' WHERE id_produk=$id");
...
<body>
	...
	<form name="update_user" method="post" action="edit_produk.php">
		<table border="0">
			<tr> 
				<td>ID Produk</td>
				<td><input type="text" class="input" name="id_produk" value=<?php echo $id_produk;?>></td>
			</tr>
			<tr> 
				<td>Nama produk</td>
            ...
            <tr> 
				<td>Stok</td>
				<td><input type="text" class="input" name="stok" value=<?php echo $stok;?>></td>
			</tr>
			<tr>
